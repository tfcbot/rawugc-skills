# Skincare UGC Formats — Shot List Reference

Quick-lookup shot lists for all 20 skincare UGC formats. For full prompt templates, see [SKILL.md](SKILL.md). For filled-in examples, see [examples.md](examples.md).
...
| 19 | Derm Said This | Talk to camera animatedly → Hold up product, gesture → Apply while explaining technique → Point at camera, "trust me" | 10 |
| 20 | One Product Wonder | Product hero shot on clean surface → Pick up, show all angles → Apply, close-up absorption → Hold up to camera, satisfied nod | 10 |
